...
#define MUMBLE_PLUGIN_API_MAJOR MUMBLE_PLUGIN_API_MAJOR_MACRO
#define MUMBLE_PLUGIN_API_MINOR MUMBLE_PLUGIN_API_MINOR_MACRO
#define MUMBLE_PLUGIN_API_PATCH MUMBLE_PLUGIN_API_PATCH_MACRO
