...
#define MUMBLE_PLUGIN_FUNCTIONS_MAJOR MUMBLE_PLUGIN_FUNCTIONS_MAJOR_MACRO
#define MUMBLE_PLUGIN_FUNCTIONS_MINOR MUMBLE_PLUGIN_FUNCTIONS_MINOR_MACRO
#define MUMBLE_PLUGIN_FUNCTIONS_PATCH MUMBLE_PLUGIN_FUNCTIONS_PATCH_MACRO
mumble_version_t MUMBLE_PLUGIN_FUNCTIONS_VERSION = { MUMBLE_PLUGIN_FUNCTIONS_MAJOR, MUMBLE_PLUGIN_FUNCTIONS_MINOR,
